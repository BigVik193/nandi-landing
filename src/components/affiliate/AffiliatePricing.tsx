    ...
    <section id="pricing" className="bg-section py-20">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="mt-16 text-center bg-white rounded-2xl p-8 shadow-lg max-w-3xl mx-auto">
          ...
          <h3 className="text-2xl font-bold text-black mb-3">Early Access Perks</h3>
          <p className="text-gray-700 mb-4">
            Join our exclusive group of founding affiliates and help shape the future of campaign optimization.
          </p>
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <div className="flex items-center justify-center space-x-2">
              ...
              <span className="text-gray-900 font-semibold">50% off forever</span>
            </div>
            <div className="flex items-center justify-center space-x-2">
              <svg className="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-gray-900 font-semibold">Feature requests priority</span>
            </div>
            <div className="flex items-center justify-center space-x-2">
              <svg className="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-gray-900 font-semibold">Direct founder access</span>
            </div>
          </div>
        </div>
      </div>
