    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-hero">
      ...
      <a href="/e-commerce" className="flex items-center space-x-2 hover:opacity-80 transition-opacity">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <a href="https://vikrambattalapalli.gumroad.com/l/nhsjky" target="_blank" rel="noopener noreferrer" className="bg-black text-white px-4 py-2 rounded-full font-medium text-base hover:bg-gray-800 transition-colors">
            Get Early Access
          </a>
        </div>
        ...
        <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
          <div className="flex flex-col space-y-1 px-4 py-4">
            ...
            <div className="flex flex-col space-y-3 pt-4 border-t border-gray-200">
              ...
              <a 
                href="https://vikrambattalapalli.gumroad.com/l/nhsjky" 
                target="_blank" 
                rel="noopener noreferrer" 
