...
import AnalyticsIntegration from '@/components/onboarding/AnalyticsIntegration';
...
export default function AnalyticsPage() {
  ...
  const handleNext = (data: any) => {
    ...
    window.location.href = '/onboarding/path-selection';
  };

  const handleBack = () => {
    window.location.href = '/onboarding/sdk';
  };
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20">
        <AnalyticsIntegration onNext={handleNext} onBack={handleBack} userData={userData} />
      </div>
    </>
  );
}