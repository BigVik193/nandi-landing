...
import ProjectIntake from '@/components/onboarding/ProjectIntake';
  ...
  return (
    <>
        ...
        <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <button
                onClick={() => window.location.href = '/onboarding/workspace'}
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20">
        <ProjectIntake onNext={handleNext} onBack={handleBack} userData={userData} />
      </div>
    </>
  );
}